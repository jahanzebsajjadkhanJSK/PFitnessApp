...
const WorkoutBuilderStack = createNativeStackNavigator()

export const WorkoutBuilderStackGroup = () => {
  return (
    <WorkoutBuilderStack.Navigator initialRouteName='WorkoutBuilderScreen'>
