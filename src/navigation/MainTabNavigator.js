...
import ChatHistory from '../screens/aiCoach/ChatHistory';
...
const WorkoutStackGroup = () => {
  return (
    <WorkoutStack.Navigator initialRouteName="WorkoutScreen">
      ...
      />
      <WorkoutStack.Screen
        name="StartCustomWorkoutScreen"
        component={StartCustomWorkoutScreen}
        options={{
          headerShown: true,
      ...
      />
      <WorkoutStack.Screen
        name="CustomSplitScreen"
        component={CustomSplitScreen}
        options={{
          headerShown: true,
          animationEnabled: true,
...
const ChatStackGroup = () => {
  return (
    <ChatStack.Navigator initialRouteName="AIChatScreen">
      <ChatStack.Screen
        name="AIChatScreen"
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{headerShown: false}}
      />
      <Tab.Screen name="Food Diary" component={DiaryScreen} />
      <Tab.Screen name="Home" component={HomeScreen} />
      <Tab.Screen name="Trends" component={FoodStackGroup} />

      <Tab.Screen name="More" component={ChatStackGroup} />
    </Tab.Navigator>
  );
};
